$(document).ready(function(){
  ...
  $('.product_wrap').draggable( {
      ...
      helper: function () {
        ...
        return $('<div>DRAG ME</div>').html( "DROP ME inside a list" ).css({width: '80px', height: '80px', padding:"20px 5px",  borderRadius: '30px', backgroundColor: 'rgb(133, 27, 19)', color: 'white', zIndex: '200'})
      },
